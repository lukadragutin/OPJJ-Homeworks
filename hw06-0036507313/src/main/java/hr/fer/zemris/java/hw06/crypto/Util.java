...
/**
 * Klasa koja nudi metode za pretvorbu polja bajtova
 * u heksadekadski String zapis i obratno. Jedna heksadekadska znamenka
 * predstavlja 4 bita.
...
public class Util {
	...
	private static int getFromBinary(String b, boolean complement) {
		...
		return negative ? -1 * hex : hex; //11100011 - 00011100 - 00011101
	}
}
