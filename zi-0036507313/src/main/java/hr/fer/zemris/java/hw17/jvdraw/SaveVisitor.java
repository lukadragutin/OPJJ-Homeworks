...
public class SaveVisitor implements GeometricalObjectVisitor {
	...
	public void visit(Triangle triangle) {
		...
		Color bgColor = triangle.getBgColor();
		sb.append(String.format("FTRIANGLE %s %s %s %s %s %s %s %s %s %s %s %s\n", x.x, x.y, y.x, y.y, z.x, z.y, color.getRed(), color.getGreen(), color.getBlue() , bgColor.getRed(), bgColor.getGreen(), bgColor.getBlue()));
