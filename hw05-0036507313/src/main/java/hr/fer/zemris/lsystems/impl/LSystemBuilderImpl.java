...
/**
 * Razred koji modelira i stvara primjerak L-sustava iz parametara zadanih kroz
 * tekst ili niz naredbi kojima se ureduju svojstva L-sustava.
 * 
...
public class LSystemBuilderImpl implements LSystemBuilder {
	...
	/**
	 * Duljina jedinicnog pomaka u L--sustavu Defaultna vrijednost je 0.1
	 */
	private double unitLength = 0.1;

	/**
	 * Velicina skaliranja jedinicnog pomaka kroz stupnjeve iteriranja L-sustava.
	 * Defaultna vrijednost je 1
	 */
	private double unitLengthDegreeScaler = 1;

	/**
	 * Početni položaj kornjače L-sustava u obliku vektora Defaultni položaj je (0,
	 * 0)
	 */
	private Vector2D origin = new Vector2D(0, 0);

	/**
	 * Početna orijentacija kornjače L-sustava u obliku vektora Defaultna vrijednost
	 * je 0
	 */
	private double angle = 0;

	/**
	 * Izvorni niz L-sustava Defaultna vrijednost je prazan niz
	 */
	...
	/**
	 * Stvara novi modifikator L-sustava alocirajuci članske varijable rječnika
	 * produkcija i naredbi
	 */
	...
	/**
	 * Stara i vraća primjerak L-sustava sa parametrima postavljenim u L-sustav
	 * builderu
	 */
	@Override
	...
	/**
	 * Modificira L-sustav preko teksta predanog kao polje Stringova
	 * <code>arg0</code> Postavlja redom: -početni položaj {@code origin} -početnu
	 * orijentaciju {@code angle} -veličinu jediničnog pomaka {@code unitLength}
	 * -vrijednost skaliranja jediničnog pomaka {@code unitLengthDegreeScaler}
	 * -naredbe L-sustava {@code commands} -početni niz {@code axiom} -produkcije
	 * L-sustava {@code productions}
	 * 
	 * @param arg0 polje Stringova parametara za modeliranje L-sustava
	 * @throws IllegalArgumentException ako uneseni niz ne odgovara propisanoj
	 *                                  strukturi
	...
	/**
	 * Pomoćna metoda za očitavanje nove naredbe ili produkcije iz Stringa predanog
	 * kao argument metode
	 * 
	 * @param s Znakovni niz koji sadrži naredbu ili produkciju za modeliranje
	 *          L-sustava
	 * @throws IllegalArgumentException ako niz ne poštuje propisanu strukturu
	 */
	private void commandOrProduction(String s) {
		String[] split = s.split(" ", 3);
		if (split.length != 3 || (!split[0].equalsIgnoreCase("command") && !split[0].equalsIgnoreCase("production"))
				|| split[1].length() != 1) {
	...
	/**
	 * Pomoćna metoda koja iz predanog niza s očitava koji parametar L-sustava se
	 * definira i na koju vrijednost
	 * 
	 * @param s Niz iz kojeg određujemo mijenjani parametar i njegovu novu
	 *          vrijednost
	 * @throws IllegalArgumentException ako niz ne odgovara propisanoj strukturi
	 */
	private boolean parameters(String s) {
		s.trim();
	...
	/**
	 * Pomoćna metoda za očitavanje vrijednosti skaliranja jedniničnog pomaka iz
	 * znakovnog niza
	 * 
	 * @param values Niz u kojem se nalazi nova vrijednost
	 *               {@code unitLengthDegreeScaler}
	 * @throws IllegalArgumentException ako niz ne odgovara propisanoj strukturi
	 */
	 ...
	 * @param arg1 Znakovni zapis operacije koju naredba izvršava nad L-sustavom i
	 *             argumenta operacije npr. draw 1, rotate 60)
	...
	/**
	 * Pomoćna metoda za dodavanje naredbe koja dodaje naredbe koje ne koriste
	 * argumente u svojim operacijama (npr. push i pop).
	 * 
	...
	/**
	 * Pomoćna metoda za dodavanje naredbi koje koriste {@code double} argumente u
	 * svojim operacijama (npr. draw, skip, rotate).
	 * 
	...
	/**
	 * Pomomćna metoda za dodavanje naredbe koja za argument ima RGB vrijednost boje
	 * npr. color
	 * 
	...
	/**
	 * Postavlja vrijednost početne orijentacije "kornjače" L-sustava kao kut u
	 * odnosu na x os koordinatnog sustava
	 * 
	 * @param arg0 Početna orijentacija "kornjače" u L-sustavu kao kut u stupnjevima
	 *             u odnosu na x os koordinatnog sustava
	 * @return Izmjenjeni primjerak objekta
	 */
	@Override
	...
	/**
	 * Postavlja vrijednost skaliranja pomaka "kornjače" L-sustava kroz stupnjeve
	 * iteriranja na parametar {@code arg0}
	 * 
	 * @return Izmjenjeni primjerak objekta
	 */
	@Override
	...
	/**
	 * Privatni razred koji nudi implementaciju L-sustava kojeg modeliramo razredom
	 * {@link LSystemBuilderImpl}
	 * 
	 * @author Luka Dragutin
	 */
	private class LSystemImpl implements LSystem {
		...
		/**
		 * Crta trenutni L-sustav iteriran do stupnja {@code arg0} pomoću
		 * {@link Painter} {@code arg1}.
		 * 
		 * @param arg0 Stupanj do kojeg iteriraju produkcije trenutnog L-sustava
		 * @param arg1 {@link Painter} koji crta L-sustav na GUI.
		 * @throws IllegalArgumentException ako je stupanj iteriranja produkcija
		 *                                  negativan
		...
		public void draw(int arg0, Painter arg1) {
			...
			TurtleState state = new TurtleState(origin, vectorFromAngle(angle), DEFAULT_COLOR, unitLength * Math.pow(unitLengthDegreeScaler, arg0));
			ctx.pushState(state);
		...
		/**
		 * Generira niz L-sustava iterirajući produkcije ulaznog niza {@code arg0} puta.
		 * 
		 * @param arg0 Određuje koliko puta se generiraju produkcije ukaznog niza, do
		 *             kojeg stupnja L-sustava se ide
		 */
		@Override
		...
		/**
		 * Pomočna metoda koja za generirani niz naredbi uzima jednu po jednu naredbu i
		 * traži je u rječniku naredbi, pa je po pronalasku izvrši, a u suprotnom
		 * preskače.
		 * 
		...
		/**
		 * Pomoćna metoda koja od zadanog kuta {@code angle} pronalazi koordinate
		 * jediničnog vektora i vraća primjerak sa tim koordinatama
		 * 
