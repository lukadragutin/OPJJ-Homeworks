...
public interface Environment {
	...
	/**
	 * Dohvaca trenutni direktorij okruzenja
	 */
	Path getCurrentDirectory();
	
	/**
	 * Postavlja trenutni direktorij okruzenja
	 */
	void setCurrentDirectory(Path path);
	
	/**
	 * Dohvaca zajednicke podatke pod predanim kljucem
	 */
	Object getSharedData(String key);
	
	/**
	 * Mijenja podatke pod kljucem sa novom vrijednoscu
	 */
