...
/**
 * Demo program za provjeru rada razreda SimpleHashtable
 */
...
//		Iterator<SimpleHashtable.TableEntry<String,Integer>> iter2 = examMarks.iterator();//Treba baciti IllegalStateException
//		while(iter2.hasNext()) {
...
//		Iterator<SimpleHashtable.TableEntry<String,Integer>> iter3 = examMarks.iterator(); //Treba baciti ConcurrentModificationException
//		while(iter3.hasNext()) {
