...
public class ValueWrapper {
	...
	public static OperationDouble getOperationDouble(Operator o) {
		return operationsDouble.get(o);
	}
	
	public static OperationInt getOperationInt(Operator op) {
		return operationsInt.get(op);
	}
