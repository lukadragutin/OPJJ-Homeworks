...
public class SmartScriptEngine {
	...
	private INodeVisitor visitor = new INodeVisitor() {
		...
		/**
		 * Ispisuje sadržaj {@link TextNode} {@code node} 
		 * na izlaz u {@link RequestContext}
		 */
		@Override
		...
		/**Iterira po djeci {@link ForLoopNode} čvora ovisno
		 * o njegovim parametrima*/
		@Override
...
//				}
		...
		/**
		 * Izvršava operacije ili funkcije zadane kao elementi
		 * ovog čvora
		 */
		@Override
		...
		/**
		 * Pomocna metoda za operiranje dvaju vrijednosti sa {@link ElementOperator} {@code e}
